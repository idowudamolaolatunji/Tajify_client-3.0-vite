...
function WalletStakingModal({ onUpdate, handleClose, userSlots, setShowModalStaking }) {
	...
	async function handleStaking(e) {
		try {
			...
			const res = await fetch(`${import.meta.env.VITE_SERVER_URL}/stakings/stakeholder-staking`, {
				method: "POST",
				headers: {
	...
	return (
		<div>
			<>
				<div className="overlay">
					<div className="modal wallet--modal" style={{ formStyle }}>
						...
						<div className="modal__content">
							...
							<form className="payment--form wallet--form " onSubmit={handleStaking}>
				...
				{showSuccessAlert && (
					<Alert key={"success"} alertType={"success"}>
				...
				{showFailedAlert && (
					<Alert key={"error"} alertType={"error"}>
