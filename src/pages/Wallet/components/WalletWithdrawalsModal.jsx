...
function WalletWithdrawalsModal({ onUpdate, handleClose, setShowModalWithdrawal }) {
	...
	async function handleNairaWithdrawal(e) {
		try {
			...
			const res = await fetch(`${import.meta.env.VITE_SERVER_URL}/wallets/withdraw-naira`, {
				method: "POST",
				headers: {
	...
	async function handleTajiWithdrawal(e) {
		try {
			...
			const res = await fetch(`${import.meta.env.VITE_SERVER_URL}/wallets/withdraw-taji`, {
				method: "POST",
				headers: {
					"Content-Type": "application/json",
					Authorization: `Bearer ${token}`,
	...
	return (
		<>
			<div className="overlay">
				<div className="modal wallet--modal" style={formStyle}>
					...
					<div className="modal__content">
						...
						{activeModalTab === "naira" && (
							<form className="payment--form wallet--form " onSubmit={handleNairaWithdrawal}>
						...
						{activeModalTab === "taji" && (
							<form className="payment--form wallet--form" onSubmit={handleTajiWithdrawal}>
								<div className="form__item">
